    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              Your trusted e-commerce platform with offline capabilities and modern shopping experience.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/account" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Account
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-sm">support@shopcraft.com</span>
              </li>
              <li className="flex items-center space-x-3">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400 text-sm">
            © 2024 ShopCraft. All rights reserved. | PWA enabled for offline shopping experience.
          </p>
        </div>
      </div>
    </footer>
